  ...
  const industries = [
    {
      ...
      icon: <FaHeartbeat className="text-[#6B6159] hover:text-[#3F3A34] transition-colors text-3xl" />,
    },
    {
      title: "eCommerce",
      description:
      ...
      icon: <FaShoppingCart className="text-[#6B6159] hover:text-[#3F3A34] transition-colors text-3xl" />,
    },
    {
      title: "Real Estate",
      description:
      ...
      icon: <FaBuilding className="text-[#6B6159] hover:text-[#3F3A34] transition-colors text-3xl" />,
    },
    {
      title: "Manufacturing",
      description:
      ...
      icon: <FaIndustry className="text-[#6B6159] hover:text-[#3F3A34] transition-colors text-3xl" />,
    },
    {
      title: "Education",
      description:
      ...
      icon: <FaGraduationCap className="text-[#6B6159] hover:text-[#3F3A34] transition-colors text-3xl" />,
    },
    {
      title: "On-Demand",
      description:
      ...
      icon: <FaBolt className="text-[#6B6159] hover:text-[#3F3A34] transition-colors text-3xl" />,
    },
  ];
      ...
      <div className="container mx-auto px-6 lg:px-20 grid grid-cols-1 md:grid-cols-2 gap-10">
        {industries.map((industry, index) => (
          <div key={index} className="flex items-start gap-4 bg-[#ECE4D9] p-6 rounded-lg shadow-md">
            <div className="p-3  rounded-full">{industry.icon}</div>
