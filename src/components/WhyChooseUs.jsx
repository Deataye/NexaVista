        ...
        <div className="lg:w-1/2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start gap-4">
              <Wallet className="text-[#3F3A34]" size={32} />
              <div>
            ...
            <div className="flex items-start gap-4">
              <CheckCircle className="text-[#3F3A34]" size={32} />
              <div>
                <h3 className="text-lg font-bold">Less Error-Rates</h3>
                <p className="text-sm">
            ...
            <div className="flex items-start gap-4">
              <Users className="text-[#3F3A34]" size={32} />
              <div>
                <h3 className="text-lg font-bold">Great Work and Team</h3>
                <p className="text-sm">
            ...
            <div className="flex items-start gap-4">
              <Code className="text-[#3F3A34]" size={32} />
              <div>
                <h3 className="text-lg font-bold">Best Product Quality</h3>
                <p className="text-sm">
