  ...
  return (
    ...
    >
      <div className="container flex flex-col lg:flex-row items-center justify-center px-6 lg:px-0 gap-10">
        ...
        <div
          ref={mainImageRef}
          className="relative w-[1200px] flex border-[10px] rounded-sm border-[#514C4A] justify-center overflow-hidden group"
        >
          {/* Large Image */}
          <Image
            src="/2.jpg"
            ...
            width={1000}
            height={1200}
            className="object-cover rounded-sm shadow-2xl transition-transform duration-500 group-hover:scale-105"
          />

          {/* Small Overlapping Image */}
          <div
            ref={smallImageRef}
            className="absolute bottom-0 left-0 border-[10px] shadow-2xl rounded-sm border-[#514C4A] transition-transform duration-500 group-hover:-translate-y-2"
          >
            <Image src="/3.jpeg" alt="Team Discussion" width={350} height={350} />
          </div>
        </div>
      </div>
    </section>
