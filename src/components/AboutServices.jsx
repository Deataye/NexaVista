...
const AboutServices = () => {
  return (
    <section className="bg-black text-[#ECE4D9] py-16">
      <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center gap-12">
        {/* Left Side - Images */}
        <div className="relative w-full lg:w-1/2">
          <Image
            src="/WelcomeToNxVs.jpg"
            alt="Team Meeting"
            width={500}
            height={500}
          ...
          <Image
            ...
            width={250}
            height={250}
            className="absolute bottom-[-40px] left-12 rounded-lg shadow-lg"
          />
          {/* Certified Badge */}
        ...
        <div className="w-full lg:w-1/2">
          <h2 className="text-4xl font-extrabold leading-tight">
            ...
            <span className="text-[#3F3A34]">Service</span> to Meet Your Specific Needs
          </h2>
          ...
          <div className="mt-8 flex flex-col md:flex-row gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-bold text-lg">Technical Advancements</h4>
                <p className="text-sm">We stay ahead of the competition with cutting-edge technology.</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <span className="text-2xl">📈</span>
              <div>
                <h4 className="font-bold text-lg">IT Consultancy</h4>
                <p className="text-sm">Our experts provide tailored IT consulting services.</p>
              </div>
            </div>
          </div>
          ...
          <Link
            href="/contact"
            className="mt-6 inline-block bg-[#3F3A34] hover:bg-[#2F2A24] text-[#ECE4D9] px-6 py-3 rounded-lg text-lg font-semibold transition-all"
          >
            Read More →
          </Link>
        </div>
